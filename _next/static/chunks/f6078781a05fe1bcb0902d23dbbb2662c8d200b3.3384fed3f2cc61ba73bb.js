  ...
  [5],
  {
    ...
    Nh2W: function (t, e, r) {
      ...
      function p() {
        ...
        return Promise.race([
          t,
          f(3800, h(new Error("Failed to load client build manifest"))),
        ]);
      }
      function d(t, e) {
        return p().then(function (r) {
          if (!(e in r))
            throw h(new Error("Failed to lookup route: ".concat(e)));
                  ...
                  (e = (function (t, e) {
                    return new Promise(function (r, n) {
                      ((e = document.createElement("script")).onload = r),
                        (e.onerror = function () {
                          return n(
                            h(new Error("Failed to load script: ".concat(t))),
                          );
                        }),
    ...
    elyg: function (t, e, r) {
      ...
      function O(t, e, r) {
        var n = new URL(t, "http://n"),
          o = "string" === typeof e ? e : (0, f.formatWithValidation)(e);
        if (!E(o)) return r ? [o] : o;
        try {
          var a = new URL(o, n);
      ...
      function T(t, e, r) {
        var n = O(t.pathname, e, !0),
          ...
          a = o[0],
          i = o[1],
          c = (0, f.getLocationOrigin)(),
          s = a.startsWith(c),
          l = i && i.startsWith(c);
        (a = C(a)), (i = i ? C(i) : i);
        var h = s ? a : S(a),
          p = r ? C(O(t.pathname, r)) : i || a;
        return { url: h, as: l ? p : S(p) };
      }
        ...
        function t(e, r, n, o) {
          ...
          a(this, t),
            ...
            (this.onPopState = function (t) {
              ...
              if (e) {
                ...
                i.changeState(
                  "replaceState",
                  (0, f.formatWithValidation)({ pathname: S(c), query: s }),
                  (0, f.getURL)(),
                );
              }
            }),
          ...
          (this.asPath = _ ? e : n),
            ...
            "//" !== n.substr(0, 2) &&
              this.changeState(
                "replaceState",
                (0, f.formatWithValidation)({ pathname: S(e), query: r }),
                (0, f.getURL)(),
                { locale: w },
              ),
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 50:
                              if (
                                ((x = this._resolveHref(x, A)).pathname !== C &&
                                  ((C = x.pathname),
                                  (o = (0, f.formatWithValidation)(x))),
                                (C = C
                                  ? (0, c.removePathTrailingSlash)(k(C))
                                  : C),
                                this.urlIsNew(w) || h || (r = "replaceState"),
                            ...
                            case 62:
                              ...
                              if (
                                ((U = (0, d.parseRelativeUrl)(M)),
                                (W = U.pathname),
                                (F = (0, y.getRouteRegex)(N)),
                                (q = (0, m.getRouteMatcher)(F)(W)),
                                (G = (B = N === W) ? R(N, W, j) : {}),
                                q && (!B || G.result))
                              ) {
                                e.next = 77;
                            ...
                            case 105:
                              return (
                                (e.next = 107),
                                this.getRouteInfo(rt, rt, j, a, { shallow: !1 })
                              );
                            case 107:
                              V = e.sent;
                            case 108:
                            ...
                            case 113:
                              ...
                              throw (
                                (t.events.emit("routeChangeError", X, w, g), X)
                              );
                            case 116:
                              return (
                      ...
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 11:
                              (f = e.sent), (l = f.page), (h = f.styleSheets);
                            case 14:
                              if (
                                (p = {
                                  props: undefined,
                        ...
                        for (;;)
                          switch ((t.prev = t.next)) {
                            case 0:
                              return (
                                (r =
                                  h.length > 1 && void 0 !== h[1] ? h[1] : e),
                                (o =
                                  h.length > 2 && void 0 !== h[2] ? h[2] : {}),
      ...
      (e.default = D), (D.events = (0, h.default)());
    },
    "g/15": function (t, e, r) {
      "use strict";
      var n = r("o0o1"),
