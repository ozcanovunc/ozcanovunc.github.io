  ...
  [7],
  {
    ...
    IKlv: function (e, t, r) {
      ...
      var C = function (e) {
        ...
        G = j || "";
      (r.p = "".concat(G, "/_next/")),
        x.setConfig({ serverRuntimeConfig: {}, publicRuntimeConfig: I || {} });
      var J = (0, E.getURL)();
      (0, S.hasBasePath)(J) && (J = (0, S.delBasePath)(J));
      var U = new T.default(F, G),
        Y = function (e) {
          var t = l(e, 2),
            r = t[0],
            n = t[1];
              ...
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 36:
                      return (
                        (t.router = Z = (0, A.createRouter)(R, O, J, {
                          initialProps: M,
                          pageLoader: U,
                          App: K,
                          Component: z,
          ...
          U.loadPage("/_error").then(function (n) {
            var o = n.page,
              ...
              u = {
                ...
                AppTree: i,
                router: Z,
                ctx: { err: r, pathname: R, query: O, asPath: J, AppTree: i },
              };
      ...
      var de = function (e) {
        return function (t) {
          var r = (0, m.default)({}, t, { Component: z, err: L, router: Z });
          return h.default.createElement(
            pe,
            null,
      ...
      function me(e) {
        ...
        return (
          ...
          (l = h.default.createElement(h.default.StrictMode, null, p)),
          (f = te),
